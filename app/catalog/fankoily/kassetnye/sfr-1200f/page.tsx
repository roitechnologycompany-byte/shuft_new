...
export const metadata: Metadata = {
  title: 'Shuft SFR-1200F — кассетный фанкойл 7.5 кВт | Цена 89 200 ₽',
  description: 'SFR-1200F — кассетный фанкойл 7.5 кВт для офисов и торговых залов 50–70 м². Встраивается в подвесной потолок 600×600 мм. Гарантия 3 года.',
  alternates: {
...
const productSchema = {
  ...
  description: 'Кассетный фанкойл мощностью 7.5 кВт для помещений 50–70 м². Монтаж в потолок Armstrong 600×600 мм.',
  sku: 'SFR-1200F',
  offers: {
    '@type': 'Offer',
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-6">
          <div className="lg:col-span-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Shuft SFR-1200F</h1>
            <p className="text-gray-600 mb-6">Кассетный фанкойл 7.5 кВт — идеален для офисов, торговых залов и переговорных 50–70 м²</p>
            <div className="bg-gray-100 rounded-2xl h-64 flex items-center justify-center mb-6 text-gray-400">
              [Фото кассетного фанкойла SFR-1200F]
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
              {[
                { icon: '❄️', label: 'Охлаждение', value: '7.5 кВт' },
                { icon: '🔊', label: 'Шум', value: '34 дБА' },
                { icon: '💨', label: 'Воздух', value: '1 350 м³/ч' },
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-4">
              <div className="bg-white border-2 border-blue-200 rounded-2xl p-5 shadow-sm">
                <div className="text-3xl font-bold text-blue-600 mb-1">89 200 ₽</div>
              ...
              <div className="bg-gray-50 rounded-2xl p-4">
                ...
                {[
                  ...
                  { name: 'SFR-1500F', power: '10 кВт', price: '112 000 ₽', href: '/catalog/fankoily/kassetnye/sfr-1500f' },
                ].map((m, i) => (
