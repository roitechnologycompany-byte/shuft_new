...
export const metadata: Metadata = {
  title: 'Shuft SFF-500G50 — канальный фанкойл 5 кВт | Цена 64 000 ₽',
  description: 'SFF-500G50 — канальный фанкойл 5 кВт для скрытого монтажа в помещениях 35–50 м². Уровень шума 30 дБА. Официальный дилер Shuft. Гарантия 3 года.',
  alternates: {
...
const productSchema = {
  ...
  description: 'Канальный фанкойл мощностью 5 кВт для скрытого монтажа в помещениях 35–50 м². Уровень шума 30 дБА.',
  sku: 'SFF-500G50',
  offers: {
    '@type': 'Offer',
...
const specs = [
  ...
  { label: 'Мощность обогрева', value: '7.0 кВт' },
  { label: 'Расход воздуха', value: '1 000 м³/ч' },
  { label: 'Уровень шума', value: '30 дБА' },
  { label: 'Площадь помещения', value: '35–50 м²' },
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-6">
          <div className="lg:col-span-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Shuft SFF-500G50</h1>
            <p className="text-gray-600 mb-6">Канальный фанкойл 5 кВт со скрытым монтажом — оптимальное решение для офисов и квартир площадью 35–50 м²</p>
            <div className="bg-gray-100 rounded-2xl h-64 flex items-center justify-center mb-6 text-gray-400">
              [Фото канального фанкойла SFF-500G50]
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
              {[
                { icon: '❄️', label: 'Охлаждение', value: '5.0 кВт' },
                { icon: '🔊', label: 'Шум', value: '30 дБА' },
                { icon: '💨', label: 'Воздух', value: '1 000 м³/ч' },
                { icon: '📏', label: 'Площадь', value: '35–50 м²' },
              ].map((s, i) => (
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-4">
              <div className="bg-white border-2 border-green-200 rounded-2xl p-5 shadow-sm">
                <div className="text-3xl font-bold text-green-600 mb-1">64 000 ₽</div>
              ...
              <div className="bg-gray-50 rounded-2xl p-4">
                ...
                {[
                  { name: 'SFF-300G50', power: '3 кВт', price: '52 000 ₽', href: '/catalog/fankoily/kanalnye/sff-300g50' },
