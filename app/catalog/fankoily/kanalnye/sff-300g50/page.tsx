...
export const metadata: Metadata = {
  title: 'Shuft SFF-300G50 — канальный фанкойл 3 кВт | Цена 52 000 ₽',
...
const productSchema = {
  ...
  description: 'Канальный фанкойл мощностью 3 кВт для скрытого монтажа в помещениях 20–30 м². Уровень шума 28 дБА.',
  sku: 'SFF-300G50',
  offers: {
    '@type': 'Offer',
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-6">
          <div className="lg:col-span-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Shuft SFF-300G50</h1>
            <p className="text-gray-600 mb-6">Канальный фанкойл 3 кВт со скрытым монтажом — бесшумное климатическое решение для небольших помещений 20–30 м²</p>
            <div className="bg-gray-100 rounded-2xl h-64 flex items-center justify-center mb-6 text-gray-400">
              [Фото канального фанкойла SFF-300G50]
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
              {[
                { icon: '❄️', label: 'Охлаждение', value: '3.0 кВт' },
                { icon: '🔊', label: 'Шум', value: '28 дБА' },
                { icon: '💨', label: 'Воздух', value: '600 м³/ч' },
                { icon: '📏', label: 'Площадь', value: '20–30 м²' },
              ].map((s, i) => (
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-4">
              <div className="bg-white border-2 border-green-200 rounded-2xl p-5 shadow-sm">
                <div className="text-3xl font-bold text-green-600 mb-1">52 000 ₽</div>
