...
export const metadata: Metadata = {
  title: 'Shuft SFF-800G50 — канальный фанкойл 8 кВт | Цена 89 000 ₽',
  description: 'SFF-800G50 — канальный фанкойл 8 кВт для скрытого монтажа в помещениях 55–75 м². Расход воздуха 1 400 м³/ч. Официальный дилер Shuft. Гарантия 3 года.',
  alternates: {
...
const productSchema = {
  ...
  description: 'Канальный фанкойл мощностью 8 кВт для скрытого монтажа в помещениях 55–75 м². Расход воздуха 1 400 м³/ч.',
  sku: 'SFF-800G50',
  offers: {
    '@type': 'Offer',
    url: 'https://shuft.online/catalog/fankoily/kanalnye/sff-800g50/',
    priceCurrency: 'RUB',
    price: '89000',
...
const specs = [
  ...
  { label: 'Мощность охлаждения', value: '8.0 кВт' },
  { label: 'Мощность обогрева', value: '11.0 кВт' },
  { label: 'Расход воздуха', value: '1 400 м³/ч' },
  { label: 'Уровень шума', value: '32 дБА' },
  { label: 'Площадь помещения', value: '55–75 м²' },
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-6">
          <div className="lg:col-span-2">
            <div className="mb-2">
              <span className="inline-block bg-green-100 text-green-700 text-xs font-medium px-3 py-1 rounded-full">Канальный фанкойл</span>
            </div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Shuft SFF-800G50</h1>
            <p className="text-gray-600 mb-6">Канальный фанкойл 8 кВт со скрытым монтажом — мощное решение для офисов, переговорных и торговых помещений 55–75 м²</p>
            <div className="bg-gray-100 rounded-2xl h-64 flex items-center justify-center mb-6 text-gray-400">
              [Фото канального фанкойла SFF-800G50]
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
              {[
                { icon: '❄️', label: 'Охлаждение', value: '8.0 кВт' },
                { icon: '🔊', label: 'Шум', value: '32 дБА' },
                { icon: '💨', label: 'Воздух', value: '1 400 м³/ч' },
                { icon: '📏', label: 'Площадь', value: '55–75 м²' },
              ].map((s, i) => (
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-4">
              <div className="bg-white border-2 border-green-200 rounded-2xl p-5 shadow-sm">
                <div className="text-3xl font-bold text-green-600 mb-1">89 000 ₽</div>
              ...
              <div className="bg-gray-50 rounded-2xl p-4">
                ...
                {[
                  ...
                  { name: 'SFF-1400G50', power: '14 кВт', price: '145 000 ₽', href: '/catalog/fankoily/kanalnye/sff-1400g50' },
                ].map((m, i) => (
